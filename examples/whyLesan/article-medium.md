...
- **Level 1** — 250 countries, by population: **250 documents**
- **Level 2** — 50 recent + 50 oldest users per country: **250 × 2 × 50**
- **Level 3** — 50 populous provinces per country: **250 × 50**
- **Level 4** — 50 recent + 50 oldest users per province: **250 × 50 × 2 × 50**
- **Level 5** — 50 populous cities per country: **250 × 50**
- **Level 6** — 50 recent + 50 oldest users per city: **250 × 50 × 2 × 50**
...
[[ IMAGE 1: Diagram of a country document with two embedded province arrays — insert "assets/diagram-provinces-sorted.png" ]]
...
[[ IMAGE 2: Lesan Playground: adding a country — insert "assets/playground-add-country.png" ]]
...
[[ IMAGE 3: Mongo Compass: a country document with the embedded, sorted arrays — insert "assets/mongo-compass-country-embedded.png" ]]
...
[[ IMAGE 4: Lesan Playground: adding a province — insert "assets/playground-add-province.png" ]]
