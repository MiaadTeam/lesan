...
![A comparison chart showing the read-write asymmetry — a giant "reads per day" bar next to tiny "writes per day" bars for a blog article, a social post, and a user profile. Dark background, cyan accent, labeled "The law of data: reads dominate, writes are rare."](assets/article2/00-A%20comparison%20chart%20showing%20the%20read-write%20asymmetry.jpg)
...
![A simple entity-relationship diagram — "user" and "article" boxes with two arrows: article → author (single snapshot) and user → articles (array of 50, sorted newest-first). Annotation: "embedded both ways, synced by Lesan."](assets/article2/01-A%20simple%20entity-relationship%20diagram%20%E2%80%94%20_user_%20and%20_article_%20boxes%20with%20two%20arrows-%20article%20%E2%86%92%20author.jpg)
...
![A diagram showing a "country" node with "population field changes every 5s" and a fan of arrows radiating out to "human 1", "human 2", "…", "human 1,000,000,000+". Dark theme, red warning accent. Caption: "The nightmare — every embedded copy must be refreshed."](assets/article2/02-A%20diagram%20showing%20a%20%22country%22%20node%20with%20%22population%20field%20changes%20every%205s%22.jpg)
...
![A diagram showing "country" at the top with an arrow to a "population" model box — "last 50 population records embedded" — and the population records pointing back to the country. Annotation: "population promoted from a field to a model. Lesan encourages you to have children."](assets/article2/03-%20A%20diagram%20showing%20%22country%22%20at%20the%20top%20with%20an%20arrow%20to%20a%20%22population%22%20model%20box.jpg)
