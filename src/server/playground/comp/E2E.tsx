            ...
            <section className="e2e_help-content">
              ...
              <p>
                ...
                <ul>
                  ...
                  <li>
                    Import: This button stands for importing an E2E config in
                    JSON format.
                  </li>
                  <li>
                  ...
                  <li>
                    Help: This button switches to the help of the E2E modal
                    page.
                  </li>
                </ul>
              </p>
              ...
              <div>
                ...
                <section className="e2e_help--section---right-side">
                  <p>
                    The right side is a set of configurations for the repeat
                    time of each request and capturing variables of the request
                    response. In the Capture Variables section, you can add a
                    pair of tuple inputs for the key name of the capture
                    variable and its value. You can capture the value of a
                    capture variable with braces syntax. For example, if you get
                    back this response from a request:
...
{"}\n"}
                ...
                <section className="e2e_help--section---right-side">
                  ...
                  />
                  <p>
                    The left side is a text area for writing headers and the
                    body of the request in JSON format. In this text area, you
                    can use a text parser to implement the captured value you
                    captured before inside these symbols {"{}"}.
                  </p>
                </section>
                ...
                <p>
                  Also, we have some buttons on the top right side of each
                  request section. With these buttons, you can move up and down
                  and delete requests.
                  <img
              ...
              <div>
                <p>
                  ...
                  prepopulate the Header and Body text areas with the sent
