...
export default function InfoIcon() {
  return (
    ...
    //       <g>
    //         {" "}
    //         <path d="M402.452,9.389l-13.923,13.923l60.318,60.322h-98.02c-48.865,0-88.615,39.755-88.615,88.615v138.731 c0,38.005-30.923,68.923-68.928,68.923H0v19.692h193.284c48.861,0,88.62-39.755,88.62-88.615V172.25 c0-38.005,30.923-68.923,68.923-68.923h98.02l-60.318,60.322l13.923,13.923l84.087-84.091L402.452,9.389z"></path>{" "}
    //       </g>{" "}
    //     </g>{" "}
    //     <g>
    //       {" "}
    //       <g>
    //         {" "}
    //         <path d="M402.452,308.966l-13.923,13.923l60.318,60.322h-98.02c-21.452,0-41.308-9.731-54.481-26.692l-15.558,12.077 c16.933,21.803,42.462,34.308,70.038,34.308h98.02l-60.318,60.322l13.923,13.923l84.087-84.091L402.452,308.966z"></path>{" "}
    //       </g>{" "}
    //     </g>{" "}
    //     <g>
    //       {" "}
    //       <g>
    //         {" "}
    //         <path d="M193.284,86.942H0v19.692h193.284c20.337,0,39.534,8.918,52.668,24.466l15.039-12.712 C244.106,98.404,219.428,86.942,193.284,86.942z"></path>{" "}
    //       </g>{" "}
    //     </g>{" "}
    //   </g>
    // </svg>
